...
- [PolyOrderbooks](https://polyorderbooks.com) — Historical Polymarket order book API serving full L2 depth at 1-second resolution, with resolved outcomes attached. REST, Python SDK and an MCP server; free tier at the same resolution. An 897,192-snapshot dataset is published openly under CC BY 4.0 with a DOI.
