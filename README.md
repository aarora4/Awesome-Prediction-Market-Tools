...
- [WinWeatherBot](https://winweatherbot.com) — Windows desktop bot for trading weather markets on Polymarket. 138-model ensemble, sub-200ms execution, self-custody, Microsoft-signed.
