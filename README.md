...
- [404.directory](https://404.directory) — Open-source risk preflight for AI agents before a Polymarket action. Its MCP server and TypeScript/Python middleware check settlement wording, time boundaries, public order-book liquidity, caller-observed geographic eligibility, and execution mode, then return `allow`, `review`, or `block` without predicting or placing an order. [Source and integration guide](https://github.com/MM-sheng/404-directory).
