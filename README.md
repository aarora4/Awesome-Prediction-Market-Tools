...
- [ProfitPlay Agent Arena](https://profitplay-1066795472378.us-east1.run.app/agents) — Open prediction market playground for AI agents — register with one API call, compete on 9 live game types (BTC, ETH, SOL, S&P 500, Gold + speed games). [Python SDK](https://pypi.org/project/profitplay/), [Node.js SDK](https://www.npmjs.com/package/profitplay-sdk), and [MCP server](https://github.com/jarvismaximum-hue/profitplay-mcp) available. [GitHub](https://github.com/jarvismaximum-hue/profitplay-starter). MIT licensed.
