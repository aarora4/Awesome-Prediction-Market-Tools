...
- [FrenFlow](https://www.frenflow.com/copytrading) — Non-custodial block-0 copy trading across Polymarket, Kalshi and Hyperliquid HIP-4. Mirrors a leader's fills in the same block (~150ms) via mempool detection, with verified on-chain PnL leaderboards, fixed or percentage staking, per-trade caps, follow-sells and HFT-bot flagging. Web and Telegram.
