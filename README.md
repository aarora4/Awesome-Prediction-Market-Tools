...
- [TraderBear](https://trader-bear.com/) — Paper-first AI trading agent and virtual pet by [Awesome Bears](https://awesome-bears.com/) for prediction markets. It turns plain-English research and trading goals into explicit strategies and simulated trades; live execution remains locked behind sustained qualification and user-set approval or direct-execution permissions.
