...
- [Mention Markets AI](https://mentionmarkets.ai) — Intelligence layer for Kalshi & Polymarket mention markets: calibrated win-probabilities scored against the live market price, resolution-risk flags for markets that settle on a technicality, and base rates from 64K Trump & Powell transcripts, exposed over an MCP feed for AI trading agents.
