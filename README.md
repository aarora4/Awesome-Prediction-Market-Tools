...
- [GADUIN](https://gaduin.com/agents) — Zero-fee prediction market for real-world supply-chain disruption (flight, train, and ship delays and port throughput), settled automatically from public data. Open to AI agents and developers over a REST/OpenAPI API and a Model Context Protocol (MCP) server.
