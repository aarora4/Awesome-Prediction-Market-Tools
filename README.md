...
- [Polymarket Agent MCP](https://github.com/demwick/polymarket-agent-mcp) — 48-tool MCP server for AI-powered Polymarket trading. Market discovery, copy trading, smart money flow detection, backtesting, arbitrage scanning, risk management, and portfolio optimization. Works with Claude Code, Cursor, or any MCP-compatible AI client.
