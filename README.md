...
- [ImpliedData](https://implieddata.com) — Cross-platform prediction-market data: the same event matched across Polymarket, Manifold & Myriad (verified, polarity-aligned), plus the complete Polymarket on-chain tick history (404M fills). YES-normalized candles, event links & clusters, CSV/Parquet/API.
