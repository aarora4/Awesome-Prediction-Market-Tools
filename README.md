...
- [Hunch](https://www.playhunch.xyz) — Swipe-feed prediction market PWA on Base with an AI agent layer: an autonomous X (Twitter) agent that turns natural-language posts into market matches, Bankr integration for in-chat betting via the x402 protocol, and native USDC-settled markets spanning crypto prices, token market-cap milestones, and launchpad volume.
