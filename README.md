...
- [PolySpark](https://t.me/polysparkbot?start=c_gh_aarora4) — Telegram copy trading bot for Polymarket with fills landing 0–1 blocks behind the target wallet, proportional position sizing, three-step setup (paste a wallet, set allocation, confirm), keys secured in Turnkey enclaves, and on-chain verifiable execution via paired Polygonscan links for every copied trade.
