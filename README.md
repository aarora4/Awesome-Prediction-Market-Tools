...
- [ClearMarket](https://github.com/JDSource/clearmarket) — Structured intelligence layer for prediction markets. Adds parsed resolution logic, catalyst calendars, cross-platform structural mapping, and related market links to raw Polymarket and Kalshi data. 20 enriched records covering macro, geopolitics, trade, and commodities.
