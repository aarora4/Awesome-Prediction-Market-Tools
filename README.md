...
- [pytheum-mcp](https://github.com/pytheum/pytheum-mcp) — MCP server bridging AI agents to prediction-market context across Kalshi, Polymarket, and Manifold. Routes news, social, and macro events to the relevant markets via 4 tools over a public API. PIT-preserved data. Install via `npx -y @pytheum/mcp` or `uvx pytheum-mcp`.
