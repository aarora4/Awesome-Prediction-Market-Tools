...
- [PolyBridge](https://polybridge.ai/api) — Probabilistic intelligence API with REST, MCP, and Python/TypeScript SDKs. Supports prediction-market search, retrieval, and forecast probabilities from a world model trained on prediction markets.
