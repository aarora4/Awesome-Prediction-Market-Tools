...
- [Cabbge](https://cabbge.com) — Telegram bot for trading the full Hyperliquid stack from chat: HIP-4 prediction markets (bet the World Cup, the Fed, BTC price strikes), perps, and HIP-3 tokenized stocks. Bet on-chain with friends, climb a social league, and copy top traders. Non-custodial, no KYC.
