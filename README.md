...
- [The Stall MCP](https://the-stall.intuitek.ai) — Pay-per-call MCP server with 4 Polymarket-native tools: top markets by volume with resolution probabilities, sentiment-shift alerts, accuracy scoring by market category, and category performance breakdowns. Covers Limitless Markets and sports predictions too. 173 AI-callable tools via x402 USDC on Base; no API key required; ~$0.003/call.
