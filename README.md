...
- [Prediction Market Deep Dive](https://www.predictionmarketdeepdive.com/) — Geopolitics-focused Polymarket screener that scores every wallet on how it actually did when markets *resolved*: forecast hit rate, ROI, and "underdog profit" — money made buying the eventual winner cheap. Reconstructed fully on-chain, so deleted accounts and lifetime history are still visible.
