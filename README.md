...
- [Mesh](https://meshapi.app) — Context intelligence API for prediction markets providing searchable transcripts, speaker profiles, topic taxonomy, and time-series analysis tools across market-relevant events like earnings calls, political speeches, and Fed proceedings, with an MCP server for AI agent integration.
