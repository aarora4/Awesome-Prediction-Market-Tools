...
- [Polymarket Weather Command Center](https://github.com/testedmedia/polymarket-weather-command-center) — Open-source (Apache-2.0) weather intelligence dashboard for Polymarket temperature markets: multi-model forecasts, live ASOS/METAR airport-sensor observations, bucket probabilities, and market edge across 41 cities, documented against a 730-day backtest.
