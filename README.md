...
- [Polyburg](https://polyburg.com) — Telegram mini-app for automatic copy trading on Polymarket. Curates the most consistent traders from on-chain history (consistency + followability, human-approved), mirrors them into your own wallet via Copy Rules, or invests one deposit in a managed Preset (Steady · Smart · Sharp). Scalper-cycle filtering and protective sells built in. Polymarket Builders-Program member.
