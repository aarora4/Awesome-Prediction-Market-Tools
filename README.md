...
- [DeepAlpha](https://github.com/stefanoviana/deepalpha) — AI crypto trading engine with ML ensemble (XGBoost, LightGBM), 72 features, pump scanner, Grid/DCA bots, 12 exchange support via CCXT, and Telegram control panel. Open source.
