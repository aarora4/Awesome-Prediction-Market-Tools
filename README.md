...
- [Overdog](https://overdog.bet/) — Sports and esports betting terminal built on Polymarket, available as a web app and Telegram bot, with smart money analytics, copy trading, limit orders and stop-losses, and multi-chain deposits settling on Polygon.
