...
- [Weather Edge](https://stewyboy1990.github.io/weather-edge/) — AI-powered Kalshi weather trading signals using 82-member multi-model ensemble (GFS + ECMWF) with NWS bias correction. Covers temperature threshold and bracket markets across 14 US cities with Kelly criterion sizing and 92% verified win rate on settled trades.
