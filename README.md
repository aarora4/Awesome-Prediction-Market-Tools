...
- [polybot (cryptuon)](https://github.com/cryptuon/polybot) — Open-source, Python automated trading system for prediction markets (Polymarket, Kalshi) with a pip-installable package, backtesting, and AI/LLM-driven strategies.
