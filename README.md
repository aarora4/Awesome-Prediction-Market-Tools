...
- [Codex](https://www.codex.io) — GraphQL data API unifying Polymarket, Kalshi, and future venues in a single schema, serving real-time prices, trending events, OHLC probability bars, order books, and trader leaderboards. [Prediction market docs](https://docs.codex.io/prediction-markets).
