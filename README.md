...
- [Polymarket Weather Bot](https://github.com/0ywfe/polymarket-weather-bot) — Open-source Python bot that trades temperature prediction markets on Polymarket using real-time METAR airport data, calibrated probability estimation, and entry/exit thresholds.
