...
- [OpenThomas](https://github.com/PredictionMarketTrader/openthomas) — Autonomous AI agent that trades weather markets on Kalshi and Polymarket; uses a 7-model NWS-station-aware forecast consensus, leak-free hindcasts for station bias, and Brier-skill-gated Kelly sizing (MIT, Python, MCP).
